...
******************************************
*	Do start position for sprites struct.
*/
...
******************************************
*	self functions:
*	1.4.6.2.1.2.1.1.1. check_new_sprite
*	1.4.6.2.1.2.1.1.2. sprite_i
*/
...
*		1.4.6.2.1.2.1.1.2. sprite_i	 	 *
******************************************
*	The function finds a ray that points to the 
